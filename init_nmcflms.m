function [h_hat, P_k] = init_nmcflms(L, F, M, xm0, h_hat0)

% This function initializes NMCFLMS algorithm
%
%	[h_hat, P_k] = init_nmcflms(L, F, M, xm0, h_hat0)
%
...
% Version: $Id: init_nmcflms.m 425 2011-08-12 09:15:01Z mrt102 $
